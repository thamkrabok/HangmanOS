...
public class MultiThreadRespond implements Runnable{
    ...
    @Override
    public void run(){
        String  [] Word = {  "Captainmarvel","Nickfury","Loki","Vakyrie",
                "Odin","Scarlettwitch","Vision","Hawkeye", "Ironman",
                "Falcon","Hulk","Spiderman","Thanos", "Antman ",
                "Wasp","Galactus","Captainamerica", "Bucky","Spiderman",
				"Fantastic4","Ethernity","Redskull","Blackwidow","Doctorstrange",
				"Ancientone","Dormammu"};
        String RandomWord;
        char[] SecretWord;
        String User = "";
